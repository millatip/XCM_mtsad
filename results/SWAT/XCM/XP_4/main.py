    ...
    for index, (train_indices, val_indices) in enumerate(
        ...
        fold_epochs_precisons = np.concatenate(
            (
                ...
                pd.DataFrame(h.history["recall"]),
                pd.DataFrame(h.history["val_recall"]),
                pd.DataFrame(h.history["auc"]),
                pd.DataFrame(h.history["val_auc"]),
                pd.DataFrame(h.history["prc"]),
                pd.DataFrame(h.history["val_prc"]),
            ),
            axis=1,
        )
        ...
        train_val_epochs_precisons = pd.concat(
            [
                ...
                pd.DataFrame(
                    ...
                    columns=["Fold", "Epoch", "precision_train", "precision_validation", "recall_train", "recall_validation",  "auc_train", "auc_validation", "prc_train", "prc_validation",],
                ),
            ],
            axis=0,
        )
